...
import { siteConfig, techStack } from "@/constants/site"
    ...
    <section className="relative mx-auto grid min-h-[calc(100svh-5rem)] max-w-7xl items-center gap-10 px-4 py-16 lg:grid-cols-[0.9fr_1.1fr] lg:py-20">
      ...
      >
        <Badge className="mb-6 rounded-full bg-primary/10 px-4 py-2 text-primary">
          ...
          Hello, I&apos;m {siteConfig.owner}
        </Badge>
        <h1 className="max-w-3xl text-5xl font-semibold tracking-tight text-balance md:text-7xl">
          Developer and writer crafting premium web experiences.
        </h1>
        <p className="mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
          I build thoughtful frontend systems, write about technology, and shape
          digital products that feel calm, fast, and useful.
        </p>
      ...
      >
        <div className="premium-border glass-panel overflow-hidden rounded-3xl p-3">
          <Image
            ...
            alt="Stylized portfolio illustration with dashboard code panels"
            width={1400}
            height={1000}
            priority
        ...
        >
          ...
          <p className="max-w-36 text-sm font-medium">Essay draft ready</p>
        </motion.div>
      </motion.div>
    </section>
  )
